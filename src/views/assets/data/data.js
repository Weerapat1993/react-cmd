...
const data = {
  menu: {
    Guest: [
      ...
      { text: 'Categries', icon: <ActionGroupWork/>, link: '/categories' },
      { text: 'Products', icon: <ActionShoppingBasket/>, link: '/products' },
      { text: 'About', icon: <ActionInfo/>, link: '/about' },
    ],
    User: [
      { text: 'Home', icon: <ActionHome/>, link: '/' },
      { text: 'Profile', icon: <SocialPerson/>, link: '/profile' },
      { text: 'Cart', icon: <ActionShoppingCart/>, link: '/cart' },
      { text: 'Categries', icon: <ActionGroupWork/>, link: '/categories' },
      { text: 'Products', icon: <ActionShoppingBasket/>, link: '/products' },
      { text: 'Users', icon: <SocialPersonOutline/>, link: '/users' },
      { text: 'About', icon: <ActionInfo/>, link: '/about' },
    ],
    Administrator: [
      { text: 'Home', icon: <ActionHome/>, link: '/' },
      { text: 'Profile', icon: <SocialPerson/>, link: '/profile' },
      { text: 'DashBoard', icon: <ActionAssessment/>, link: '/dashboard' },
      { text: 'Categries', icon: <ActionGroupWork/>, link: '/categories' },
      { text: 'Products', icon: <ActionShoppingBasket/>, link: '/products' },
      { text: 'Users', icon: <SocialPersonOutline/>, link: '/users' },
      { text: 'About', icon: <ActionInfo/>, link: '/about' },
